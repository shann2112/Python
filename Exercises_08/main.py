...
# Lets mess around with the main class and see what I can get back from it directly
my_devices = Device()

# I will send in a value to the main class function calculate_crc and get its return value
# The main class will overwrite what I sent in on its return
